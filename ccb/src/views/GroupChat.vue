...
import GroupList from '../components/contact/GroupList.vue'
import GroupDetail from '../components/contact/GroupDetail.vue'
import GroupAvatar from '../components/contact/GroupAvatar.vue'
import BottomNavbar from '../components/layout/BottomNavbar.vue'
import GroupSearchModal from '../components/contact/GroupSearchModal.vue'
import ForwardDialog from '../components/dialog/ForwardDialog.vue'
...
async function handleDeleteMessages(messagesToDelete) {
  ...
  if (confirmed) {
    try {
      ...
      // 通过Socket通知其他群成员消息被删除
      if (socket && socket.connected && currentGroup.value) {
